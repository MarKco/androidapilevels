...
class APILevelsContent {
    ...
    companion object: APILevels {
         ...
         */
        val apiLevelsList: MutableList<SingleAndroidVersion> = ArrayList()

        /**
         * A map of SKD Versions items, by ID.
         */
        val apiLevelsListByCode: MutableMap<String, SingleAndroidVersion> = HashMap()
        ...
        override fun getAPILevels(): MutableList<SingleAndroidVersion> {
