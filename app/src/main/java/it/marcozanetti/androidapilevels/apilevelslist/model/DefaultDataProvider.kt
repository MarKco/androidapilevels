        ...
        fun getDefaultData(): List<SingleAPILevel> {
            val items =
                arrayListOf(
                    ...
                    SingleAPILevel("Oreo", "8.0.0", "August 21, 2017", false, 26, 26),
                    SingleAPILevel("Oreo", "8.1.0", "December 5, 2017", false, 27, 27),
                    SingleAPILevel("Pie", "9", "August 6, 2018", false, 28, 28),
                    SingleAPILevel("Android10", "10", "September 3, 2019", false, 29, 29),
                    SingleAPILevel("Android11", "11", "September 8, 2020", false, 30, 30),
                    SingleAPILevel("Android12", "12", "October 4, 2021", false, 31, 31),
                    SingleAPILevel("Android12L", "12L", "March 7, 2022", false, 32, 32),
                    SingleAPILevel("Android13", "13", "August 15, 2022", true, 33, 33),
                    SingleAPILevel("Android14", "14", "October 4, 2023", true, 34, 34),
                    SingleAPILevel("Android15", "15", "September 3, 2024", true, 35, 35),
                    SingleAPILevel("Android16", "16", "June 10, 2025", true, 36, 36),
                )
